...
abstract contract TRC721Enumerable is TRC721, ITRC721Enumerable {
    ...
    {
        return
            interfaceId == type(ITRC721Enumerable).interfaceId ||
    ...
    {
        require(
            index < TRC721Enumerable.totalSupply(),
    ...
    function _beforeTokenTransfer(
        ...
        if (batchSize > 1) {
            ...
            revert("TRC721Enumerable: consecutive transfers not supported");
        }
